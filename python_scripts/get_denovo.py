...
denovo_out = open(outdir + '/denovo_raw' + args.postfix + '.dat', 'w')
if make_test_data:
    het_test_out = open(outdir + '/het_test' + args.postfix + '.dat', "w")
    homoref_test_out = open(outdir + '/homoref_test' + args.postfix + '.dat', 'w')
